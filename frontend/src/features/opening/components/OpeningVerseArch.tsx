...
export function OpeningVerseArch() {
  return (
    <ScrollReveal direction="bottom" className="px-6.5 mt-22.75">
      <div
        className="relative w-full font-bold -mt-6 z-0 bg-[#4a85b8] flex flex-col items-center justify-center px-6 pt-24 pb-12 text-white text-center"
        style={{ minHeight: "75vw", borderRadius: "232px 232px 12px 12px", background: 'linear-gradient(142deg, #4299E1 0%, #3783C2 100%)' }}
      >
